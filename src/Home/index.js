...
class HomePage extends Component {
    ...
    handlePlayerLevelInputDidChange(playerLevel) {
        this.setState({
            ...
            totalAvailable: this.getSpellSlotsAvailable(playerLevel)
        });
    }
    ...
    handleAddSpellCard() {
        ...
        this.setState(prevState => {
            ...
            spells.push({
                ...
                description: spellToAdd.desc,
                level: spellToAdd.level
            });
    ...
    handleAddAbilityCard() {
        ...
        this.setState(prevState => {
            ...
            abilities.push({
                id: abilityToAdd.index,
                name: this.state.input,
                description: abilityToAdd.desc,
                cost: this.getSpellObjectFromName(this.state.input).cost
            });
            ...
            <div className="App">
                ...
                {!this.state.playerConfirmed ? (
                    <NewPlayerSection
                        ...
                        onClassChange={e =>
                            this.handlePlayerClassInputDidChange(e)
                        }
                        onNameChange={e =>
                            this.handlePlayerNameInputDidChange(e)
                        }
                        onLevelChange={e =>
                            this.handlePlayerLevelInputDidChange(e)
                        }
                        canConfirm={
                            this.state.playerName.length > 0 &&
                            this.state.playerClass.length > 0 &&
                    ...
                    <div className="app-contents">
                        <div className="app-actions">
                            <button
                                ...
                                onClick={() => this.takeLongRest()}
                            >
                                Take Long Rest
                            </button>
                            <button
                                className="short-rest-button"
                                onClick={() => this.takeShortRest()}
                            >
                                Take Short Rest
                            </button>
                        </div>
                        <div className="card-lists">
                            ...
                            <div className="card-list abilities">
                                {this.state.selectedAbilities
                                    ? this.state.selectedAbilities.map(
                                          (ability, index) => {
                                              return (
                                                  <AbilityCard
                                                      id={ability.id}
                        ...
                        <AppFooter
                            ...
                            costUnit={this.getSpellCostUnit()}
                        />
                    </div>
                ) : null}
                {this.state.cardModalOpen ? (
                    <CardModal
                        handleAddAbilityCard={this.handleAddAbilityCard.bind(
                            this
                        )}
                        handleAddSpellCard={this.handleAddSpellCard.bind(this)}
                        handleInputDidChange={this.handleInputDidChange.bind(
                            this
                        )}
                    />
                ) : null}
